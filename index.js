...
const questions = [
    {
        ...
        validate: employeeName => {
            if(employeeName) {
                ...
                console.log("Please enter the employee's name (required)");
                return false;
            }
        }
    },
    {
        ...
        validate: employeeId => {
            if(employeeId) {
                ...
                console.log('Please enter the employee id number (required)');
                return false;
            }
        }
    },
    {
        ...
        validate: employeeEmail => {
            if(employeeEmail) {
                ...
                console.log("Please enter the employee's email (required)");
                return false;
            }
        }
    },
    ...
    },
    {
        ...
        validate: school => {
            if (school) {
                ...
                console.log("Please enter the name of the school the intern attends. (required)");
                return false;
            }
        }
    },
